...
namespace GameFramePro.EditorEx
{
    ...
    public class EditorAssetBundleInfor
    {
        ...
        public string mMD5Code = string.Empty;  //编辑器下有效 用于在两个版本之间比对资源
        ...
        public override string ToString()
        {
            ...
            return string.Format("mAssetBundlePackageName= {0:30}    mMD5Code={1:50}    mPackageSize={2} ContainAsset={3}  ", mAssetBundlePackageName, mMD5Code, mPackageSize,
              mAllContainAssetInfor.Count);
        }
