...
namespace GameFramePro
{
    ...
    [System.Serializable]
    public class BaseBeReferenceGameObjectInformation : BaseBeReferenceInformation
    {
        protected GameObject mReferenceGameObjectAsset = null;

        public override bool IsReferenceAssetEnable
        {
            get { return mReferenceGameObjectAsset != null ? base.IsReferenceAssetEnable : false; }
        }

        //标示当前物体使用激活状态
        public bool IsActivity
        {
            get { return IsReferenceAssetEnable && mReferenceGameObjectAsset.activeSelf; }
        }

        protected Transform transform
        {
            get { return IsReferenceAssetEnable ? mReferenceGameObjectAsset.transform : null; }
        }

        #region 构造函数

        public BaseBeReferenceGameObjectInformation()
        {
        }

        // 被真正引用的资源 可能是CurLoadAssetRecord 中资源的某个组件或者实例化的对象
        public BaseBeReferenceGameObjectInformation(UnityEngine.Object asset, Type referenceType, LoadAssetAssetRecord assetRecord) : base(asset, referenceType, assetRecord)
        {
        ...
        protected override void ReleaseReference()
        {
