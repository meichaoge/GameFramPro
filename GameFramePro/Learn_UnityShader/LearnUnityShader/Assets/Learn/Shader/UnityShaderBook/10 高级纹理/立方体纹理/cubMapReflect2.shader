...
Shader "UnityShaderBook/10/cubMapReflect2"
{
    Properties
    {
    ...
    SubShader
    {
		...
		Tags{"LightMode"="ForwardBase"}
            ...
            v2f vert (appdata v)
            {
				...
				o.reflectDir=reflect(-1*viewDir,	o.worldNormal);
					TRANSFER_SHADOW(o);
                return o;
            }
            ...
            fixed4 frag (v2f i) : SV_Target
            {
				...
				fixed3 reflectColor=texCUBE(_Cubemap,i.reflectDir);

					UNITY_LIGHT_ATTENUATION(atten, i, i.worldPos);

				return fixed4(ambient+  lerp(   diffuse,reflectColor,_ReflectAmount)*atten,1.0);
            }
            ENDCG
        }
    }
