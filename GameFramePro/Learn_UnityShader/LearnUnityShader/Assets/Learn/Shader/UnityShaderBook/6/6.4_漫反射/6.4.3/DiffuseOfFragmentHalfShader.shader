Shader "UnityShaderBook/6.4.3/DiffuseOfFragmentHalfShader"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
			  ...
			  fixed halfLambert=0.5*dot( normalize(i. normalDir) ,worldLightDir)+0.5;

			  fixed3 diffuseColor= _DiffuseColor.rgb *  _LightColor0.rgb*halfLambert;
