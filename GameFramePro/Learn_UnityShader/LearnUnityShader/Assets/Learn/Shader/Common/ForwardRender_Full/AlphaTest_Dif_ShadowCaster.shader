...
Shader "Unlit/Common/AlphaTest_Dif_ShadowCaster"
{
//适用于使用前向渲染且处理各种逐像素的光源 AlphaTest 正确产生阴影
//采用两个Pass 第一个ForwardBase 第二个ForwardAdd
    Properties
    {
        _MainTex ("Texture", 2D) = "white" {}
		_Color("Color Tint",COLOR)=(1,1,1,1)
		_Cutoff("Alpha Cut Off",Range(0,1.0))=0.5  //FallBack 中需要使用这个名称的Alpha 裁剪值
    }
    SubShader
    {	
	...
	FallBack "Transparent/Cutout/VertexLit" //需要正确使用这个 Fallback 才能使用能够处理被裁剪的片元产生正确的阴影
}
