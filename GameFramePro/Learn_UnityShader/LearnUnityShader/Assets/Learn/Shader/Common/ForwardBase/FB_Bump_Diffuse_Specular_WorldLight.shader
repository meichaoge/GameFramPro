...
Shader "Unlit/Common/FB_Bump_Diffuse_Specular_WorldLight"
{
//适用于前向渲染中主光源关照  世界空间计算光照
	   ...
	   #include "Lighting.cginc"
		 ...
		 struct v2f
            ...
            fixed4 frag (v2f i) : SV_Target
            {
				...
				float3 worldLightDir=normalize(UnityWorldSpaceLightDir(worldPos)); //光线方向
				float3 worldViewDir=normalize(UnityWorldSpaceViewDir(worldPos));//视角方向
				...
				float3 worldNormal=normalize(float3(dot(i.w1,tangetNormal),dot(i.w2,tangetNormal),dot(i.w3,tangetNormal)));
