...
//    public class EnhancedScrollerPro : MonoBehaviour
//    {
//        #region Public
...
//            get
//            {
//                return (OnGetNumberOfCells != null ? OnGetNumberOfCells.Invoke(this) : 0);
//            }
//        }
...
//        protected System.Func<EnhancedScrollerPro, int> OnGetNumberOfCells { get; set; } = null;
//        protected System.Func<EnhancedScrollerPro,  int, float> OnGetCellViewSize { get; set; } = null;
//        protected System.Func<EnhancedScrollerPro, int, int, EnhancedScrollerCellView> OnGetCellView { get; set; } = null;
//        public bool mIsInitialed { get; private set; } = false;

//        /// <summary>
//        /// 初始化循环列表回调事件  
//        /// </summary>
//        /// <param name="GetNumberOfCellsCallback">Gets the number of cells in a list of data</param>
//        /// <param name="GetCellViewSizeCallback">Gets the size of a cell view given the index of the data set. his allows you to have different sized cells</param>
//        /// <param name="GetCellViewCallback">Gets the cell view that should be used for the data index. Your implementation of this function should request a new cell from the scroller so that it can  properly recycle old cells.</param>
//        public void InitaieldScroller(System.Func<EnhancedScrollerPro, int> GetNumberOfCellsCallback, 
//            System.Func<EnhancedScrollerPro,  int ,float> GetCellViewSizeCallback,  
//            System.Func<EnhancedScrollerPro, int,int, EnhancedScrollerCellView> GetCellViewCallback)
//        {
//            OnGetNumberOfCells = GetNumberOfCellsCallback;
//            OnGetCellViewSize = GetCellViewSizeCallback;
//            OnGetCellView = GetCellViewCallback;
//            _reloadData = true;
//            mIsInitialed = true;
//        }
...
//        public T GetCellView<T>(GameObject cellPrefab)  where T: EnhancedScrollerCellView
//        {
//            // see if there is a view to recycle
//            var cellView = _GetRecycledCellView<T>(cellPrefab);
//            if (cellView == null)
//            {
//                // no recyleable cell found, so we create a new view
//                // and attach it to our container
//                var go = Instantiate(cellPrefab.gameObject);
//                cellView = go.GetAddComponentEx<T>();
//                cellView.transform.SetParent(_container);
//                cellView.transform.localPosition = Vector3.zero;
//                cellView.transform.localRotation = Quaternion.identity;
...
//            {
//                Debug.LogError($"Please Call InitaieldScroller First ");
//                return;
//            }
...
//                // get the cell's size
//                var cellSize = (OnGetCellViewSize != null ? OnGetCellViewSize.Invoke(this, dataIndex) : 0);
...
//        {
//            return GetScrollPositionForCellViewIndex(loop ? OnGetNumberOfCells.Invoke(this) + dataIndex : dataIndex, insertPosition);
//        }
...
//                _cellViewSizeArray.Add(OnGetCellViewSize.Invoke(this, i) + (i == 0 ? 0 : _layoutGroup.spacing));
...
//        /// <param name="cellPrefab">The prefab to check for</param>
//        /// <returns></returns>
//        private T _GetRecycledCellView<T>(GameObject cellPrefab)  where T: EnhancedScrollerCellView
//        {
//             var scrollerCellView = cellPrefab.GetComponent<T>();
//            if (scrollerCellView == null) return null;

//            for (var i = 0; i < _recycledCellViews.Count; i++)
//            {
//                if (_recycledCellViews[i].cellIdentifier == scrollerCellView.cellIdentifier)
//                {
//                    // the cell view was found, so we use this recycled one.
//                    // we also remove it from the recycled list
//                    var cellView = _recycledCellViews.RemoveAt(i);
...
//            var cellView = OnGetCellView.Invoke(this, dataIndex, cellIndex);
