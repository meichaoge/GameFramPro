...
namespace Lean.Touch
{
    ...
    public class LeanFinger
    {
        ...
        {
            get { return LeanTouch.Fingers.Contains(this); }
        }
        ...
        {
            get { return LeanTouch.PointOverGui(ScreenPosition); }
        }

        /// <summary>Did this finger begin touching the screen this frame?</summary>
        public bool Down { get { return Set  && LastSet == false; } }

        /// <summary>Did the finger stop touching the screen this frame?</summary>
        public bool Up { get { return Set == false && LastSet; } }
