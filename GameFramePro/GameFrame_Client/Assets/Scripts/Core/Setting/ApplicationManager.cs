...
namespace GameFramePro
{
    ...
    {
      //  public static string S_TopCDNUrl { get; set; } = string.Format("https://superxu3d.tcmapi.cn/goalon/TestApplication/{0}/{1}", S_Instance.mAppResourcesVersion,  AppPlatformManager.GetRuntimePlatformFolderName());
        public static string S_TopCDNUrl { get; set; } = string.Format("https://supergoal-content-bucket.oss-cn-hongkong.aliyuncs.com/goalon/TestApplication/{0}/{1}", S_Instance.mAppResourcesVersion, AppPlatformManager.GetRuntimePlatformFolderName());
