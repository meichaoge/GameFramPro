...
namespace GameFramePro.NetWorkEx
{
    ...
    public class AssetBundleDownloadManager : BaseDownloadManager<UnityWebRequestDownloadTask, UnityWebRequest>
    {
        ...
        public virtual UnityWebRequestDownloadTask GetDataFromUrl(string taskUrl, uint crc, Action<UnityWebRequest, bool, string> callback, TaskPriorityEnum priorityEnum = TaskPriorityEnum.Normal)
        {
            ...
            //将新的下载任务添加到缓存的下载队列中
            UnityWebRequestDownloadTask newDownLoadTask = GetDownloadTaskInstance(taskUrl, crc, callback, priorityEnum);
        ...
        protected UnityWebRequestDownloadTask GetDownloadTaskInstance(string taskUrl, uint crc, Action<UnityWebRequest, bool, string> callback, TaskPriorityEnum priorityEnum)
        {
            ...
            UnityWebRequest webRequest = new UnityWebRequest(taskUrl)
            {
                ...
                downloadHandler = new DownloadHandlerAssetBundle(taskUrl, crc),
            };
