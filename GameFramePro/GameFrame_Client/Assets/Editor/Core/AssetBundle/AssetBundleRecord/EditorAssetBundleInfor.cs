...
namespace GameFramePro.EditorEx
{
    ...
    public class EditorAssetBundleInfor
    {
        ...
        public string mAssetRelativePath = string.Empty; //相对于AssetBundle 包的路径
        ...
        public List<EditorAssetBundleInfor> mDependenceAssetBundle = new List<EditorAssetBundleInfor>();//依赖的其他AssetBundle


        public override string ToString()
        {
            //return string.Format("mAssetBundlePackageName= {0:30}    mCRCCode={1:50}    mPackageSize={2} ContainAsset={3}  Dependence={4}", mAssetBundlePackageName, mCRCCode, mPackageSize,
            //    mAllContainAssetInfor.Count, mDependenceAssetBundle.Count);
